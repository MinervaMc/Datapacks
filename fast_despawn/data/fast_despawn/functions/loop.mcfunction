...
execute if score Gravel despawnItems = #ONE despawnItems run execute as @e[nbt={Item:{id:"minecraft:gravel"}}] run data merge entity @s {Age:5800s}
...
execute if score StoneVariants despawnItems = #ONE despawnItems run execute as @e[nbt={Item:{id:"minecraft:granite"}}] run data merge entity @s {Age:5800s}
execute if score StoneVariants despawnItems = #ONE despawnItems run execute as @e[nbt={Item:{id:"minecraft:andesite"}}] run data merge entity @s {Age:5800s}
execute if score StoneVariants despawnItems = #ONE despawnItems run execute as @e[nbt={Item:{id:"minecraft:diorite"}}] run data merge entity @s {Age:5800s}
execute if score Grass despawnItems = #ONE despawnItems run execute as @e[nbt={Item:{id:"minecraft:grass"}}] run data merge entity @s {Age:5800s}
execute if score Sand despawnItems = #ONE despawnItems run execute as @e[nbt={Item:{id:"minecraft:sand"}}] run data merge entity @s {Age:5800s}
